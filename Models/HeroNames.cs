...
public static class HeroNames
{
    ...
    public static string GetLocalizedName(string internalName) =>
        _names.TryGetValue(internalName, out var name) ? name : internalName;

    public static string GetImageKey(string internalName) =>

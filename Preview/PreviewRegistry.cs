        ...
        new(StringComparer.OrdinalIgnoreCase)
        {
            ["LauncherHeader"] = () =>
            {
                ...
                var vm = new MainLauncherViewModel(
                    ...
                    new StubDotakeysProfileService(), new StubToastNotificationService(), new StubStartupRegistrationService(), new StubPaidActionService());
            ...
            {
                var api = new StubBackendApiService();
                var vm = new ProfileViewModel(api, new StubPaidActionService());
                vm.IsOwner = true;
            ...
            ["SettingsPanel"] = () =>
            {
                ...
                var vm = new SettingsViewModel(launchStorage, cvarProvider, settingsStorage, videoProvider, new StubContentRegistryService(), new StubStartupRegistrationService());

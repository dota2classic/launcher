    ...
    private static readonly Dictionary<string, Func<(Control View, object? ViewModel)>> Registry =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["ChatPanel"] = () =>
            {
                ...
                var vm = new ChatViewModel("preview-thread", stub, new StubHttpImageService(), new StubEmoticonService(), new StubQueueSocketService(), new StubWindowService(), new StubSteamManager());
                _ = vm.StartAsync();
